    ...
    <main className='container-px pb-20 pt-32 md:pt-36'>
      <section className='mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1.2fr]'>
        ...
        <form className='space-y-5'>
          ...
          <div className='grid gap-5 sm:grid-cols-2'>
            <TextInputField id='portfolioLink' name='portfolioLink' label='Portfolio Link' />
            <TextInputField id='inspiration' name='inspiration' label='How do you get inspiration?' />
          </div>

          <div className='grid gap-5 sm:grid-cols-2'>
            <TextInputField id='deadlines' name='deadlines' label='How do you manage tight deadlines?' />
            <SelectField
              id='teamwork'
              name='teamwork'
          ...
          <div className='grid gap-5 sm:grid-cols-2'>
            ...
            <TextInputField id='additionalNote' name='additionalNote' label='Any addition note?' />
          </div>
        </form>
      </section>
    </main>
