...
const heroCards: HeroCard[] = [
  {
    front: '/assets/images/sections/hero/marketing.front.png',
    back: '/assets/images/sections/hero/marketing.back.png',
    alt: 'Marketing',
  },
  {
    front: '/assets/images/sections/hero/business-growth.front.png',
    back: '/assets/images/sections/hero/business-growth.back.png',
    alt: 'Business Growth',
  },
  {
    front: '/assets/images/sections/hero/branding.front.png',
    back: '/assets/images/sections/hero/branding.back.png',
    alt: 'Branding',
  },
];
